...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint(filepath = 'Model/TVL/'+filepath, monitor='val_acc',verbose=1,save_best_only=False)
    ...
    csv_logger = CSVLogger('logs/TVL.log')
    ...
    model.save('Model/TVL/Final_Model.h5')
...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint(filepath = 'Model/X_weight_high/'+filepath, monitor='val_acc',verbose=1,save_best_only=False)
    ...
    csv_logger = CSVLogger('logs/X_weight_high.log')

    #######Training############
    df = pd.read_csv('data/WEIGHT_TRAINING_HIGH.csv')
    ...
    train_generator = train_datagen.flow_from_dataframe(df,x_col='PATH', y_col='LABEL', weight_col='X_Weight',
                                                        target_size=input_shape,  
                                                        class_mode='categorical', batch_size=train_batch_size)
    ...
    model.save('Model/X_weight_high/Final_Model.h5')

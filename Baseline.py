...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint(filepath = 'Model/Baseline/'+filepath, monitor='val_acc',verbose=1,save_best_only=False)
    ...
    model.save('Model/Baseline/Baseline_Model.h5')